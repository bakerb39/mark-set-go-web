(() => {
  ...
  function injectStyles() {
    ...
    style.textContent = `
      .random-notes-page{max-width:1180px;margin:0 auto}.random-notes-layout{display:grid;grid-template-columns:minmax(0,1.35fr) minmax(280px,.65fr);gap:1rem}.random-note-editor-card,.random-note-list-card{background:var(--panel,#fff);border:1px solid var(--border,#d6dfda);border-radius:18px;padding:1rem}.random-note-title{width:100%;font-size:1.2rem;font-weight:750;margin-bottom:.65rem}.random-note-toolbar{display:flex;gap:.45rem;flex-wrap:wrap;align-items:center;margin-bottom:.65rem}.random-note-editor{min-height:360px;resize:vertical;overflow:auto;border:1px solid var(--border,#ccd6d1);border-radius:12px;padding:1rem;background:#fff;line-height:1.55;white-space:pre-wrap}.random-note-editor:focus{outline:3px solid rgba(30,125,91,.16);border-color:#2c8a68}.random-note-editor img{max-width:100%;height:auto;border-radius:10px;display:block;margin:.7rem 0}.random-note-meta{font-size:.78rem;color:var(--muted,#66736d);margin:.5rem 0}.random-note-actions{display:flex;gap:.5rem;flex-wrap:wrap;margin-top:.75rem}.random-note-card{border:1px solid var(--border,#d8e0dc);border-radius:12px;padding:.8rem;margin:.55rem 0;background:#fff}.random-note-card h3{margin:0 0 .25rem}.random-note-preview{font-size:.86rem;color:#53615b;max-height:4.1em;overflow:hidden}.random-note-badges{display:flex;gap:.35rem;flex-wrap:wrap;margin:.35rem 0}.random-note-badge{font-size:.68rem;background:#e8f4ef;color:#176b50;padding:.18rem .42rem;border-radius:999px}.random-note-image-help{font-size:.78rem;color:#64716c}.random-note-status{min-height:1.25rem;margin-top:.5rem}.cloud-document-state{font-size:.72rem;font-weight:750;margin-left:.35rem}.cloud-document-state.metadata{color:#936d00}.cloud-document-state.document{color:#176b50}.email-cloud-status{display:grid;grid-template-columns:repeat(auto-fit,minmax(160px,1fr));gap:.45rem;margin-top:.75rem}.email-cloud-status span{padding:.55rem .7rem;border-radius:10px;background:#f2f6f4;font-size:.78rem}.email-cloud-status .ok{color:#176b50}.email-cloud-status .off{color:#865e00}@media(max-width:850px){.random-notes-layout{grid-template-columns:1fr}}
    `;
