(() => {
  ...
  const BETH_FRONTPAGE = '/assets/companions/beth/beth-frontpage-badge.png?v=9.6.8';
  const BETH_READING = '/assets/companions/beth/beth-avatar.png?v=9.6.8';
  const BETH_POINTING = '/assets/companions/beth/beth-avatar.png?v=9.6.8';
